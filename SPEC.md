...
option with a real accessible date-range picker for the 4-week booking cap — ADR-0011);
`cva` + `clsx` map variants to classes. **22 P0 primitives + 13 P1 feature-composed** components
inventoried in [`docs/design-system-inventory.md`](./docs/design-system-inventory.md);
